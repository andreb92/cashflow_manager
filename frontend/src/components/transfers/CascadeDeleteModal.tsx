...
interface Props {
  ...
  isRecurring: boolean; isPending: boolean;
}

export default function CascadeDeleteModal({ open, onClose, onConfirm, isRecurring, isPending }: Props) {
  return (
    <Modal open={open} onClose={onClose} title="Delete transfer">
      {isRecurring ? (
        <div className="flex flex-col gap-3">
          <p className="text-sm text-gray-600">This is a recurring transfer. What do you want to delete?</p>
        ...
        <div className="flex flex-col gap-3">
          <p className="text-sm text-gray-600">Delete this transfer?</p>
